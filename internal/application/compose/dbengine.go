...
func renderSource(command, engine, name, providerName, database string) string {
	...
	// Explicit so DL020 doesn't flag generated output (ADR 024's bar:
	// composites and lints co-evolve — same idiom as the blueprints).
	lines = append(lines, "deletionPolicy: retain")
