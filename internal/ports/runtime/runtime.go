...
type ContainerSpec struct {
	...
	// (docs/design/004-replicas-and-identity.md). 0 and 1 are equivalent to
	...
	// itself (e.g. Trino workers, docs/design/006-compute-engines.md) —
...
// runtime first — docs/design/004-replicas-and-identity.md).
...
type ContainerState struct {
	...
	// (docs/design/004-replicas-and-identity.md, "the provider decides
	// meaning").
	ReadyReplicas int
}
...
const (
	...
	// LabelReplicaBase and LabelReplicaOrdinal (docs/design/004) let an
