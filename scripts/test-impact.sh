...
openziti|internal/adapters/providers/openziti internal/ports/mediation internal/application/graphaccess internal/domain/naming internal/adapters/providers/debezium internal/adapters/providers/postgres internal/ports/runtime internal/domain/connection cmd/platformctl/testdata/openziti-scenario SHARED_CORE|go test -tags integration -count=1 -run 'TestOpenZitiMediatedConnectionEndToEnd' -timeout 2400s ./cmd/platformctl/
