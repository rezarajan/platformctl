# Delivered feature requests (archive)

> **Archived 2026-07-20** (moved from the repo root to `docs/history/`).
> Every request below is delivered; each entry keeps the original ask
> alongside what actually shipped. New work items belong in
> `docs/planning/08-production-readiness-plan.md`, not here.
